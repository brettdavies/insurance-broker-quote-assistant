...
**Purpose:** Define measurable success metrics that prove the architecture meets the client's requirements.
...
- **Objective metrics:** The client can run evaluation themselves, no subjective judgment
