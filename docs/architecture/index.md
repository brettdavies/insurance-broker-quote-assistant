...
- [Insurance Broker Quote Assistant (IQuote Pro) - Fullstack Architecture Document](#table-of-contents)
  ...
  - [4. Data Models](./4-data-models.md)
    ...
    - [4.5 IntakeRequest](./4-data-models.md#45-intakerequest)
    - [4.6 IntakeResult](./4-data-models.md#46-intakeresult)
    - [4.7 PolicyAnalysisResult](./4-data-models.md#47-policyanalysisresult)
    - [4.8 PrefillPacket](./4-data-models.md#48-prefillpacket)
    - [4.9 DecisionTrace](./4-data-models.md#49-decisiontrace)
    - [4.10 InferenceRule](./4-data-models.md#410-inferencerule)
    - [4.11 TextPatternInference](./4-data-models.md#411-textpatterninference)
    - [4.12 SuppressionManager](./4-data-models.md#412-suppressionmanager)
  ...
  - [7. External APIs](./7-external-apis.md)
    - [7.1 Google Gemini API](./7-external-apis.md#71-google-gemini-api)
  ...
  - [11. Backend Architecture](./11-backend-architecture.md)
    ...
    - [11.3 Google Gemini Integration](./11-backend-architecture.md#113-google-gemini-integration)
    - [11.4 Prompt Template System](./11-backend-architecture.md#114-prompt-template-system)
    - [11.5 Hybrid Inference Architecture](./11-backend-architecture.md#115-hybrid-inference-architecture-deterministic--llm)
  ...
  - [17. Coding Standards](./17-coding-standards.md)
    ...
    - [17.3 Implementation Guidance](./17-coding-standards.md#173-implementation-guidance)
      - [Data Transformation (snake_case ↔ camelCase)](./17-coding-standards.md#data-transformation-snakecase-camelcase)
  ...
  - [19. Monitoring and Observability](./19-monitoring-and-observability.md)
    ...
    - [19.3 Observability for PEAK6 Evaluation](./19-monitoring-and-observability.md#193-observability-for-peak6-evaluation)
  - [20. Success Criteria and Evaluation](./20-success-criteria-and-evaluation.md)
    - [20.1 PEAK6 Requirements Mapping](./20-success-criteria-and-evaluation.md#201-peak6-requirements-mapping)
