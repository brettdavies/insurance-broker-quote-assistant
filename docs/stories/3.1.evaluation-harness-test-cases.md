...
- Routing accuracy: ≥90% (per-carrier and per-state breakdowns) [Source: architecture/20-success-criteria-and-evaluation.md#requirements-mapping]
- Intake completeness: ≥95% (field completeness percentage) [Source: architecture/20-success-criteria-and-evaluation.md#requirements-mapping]
...
- Compliance pass rate: 100% (all outputs must pass compliance filter) [Source: architecture/20-success-criteria-and-evaluation.md#requirements-mapping]
...
- This matches the architecture document specification for the client's test cases and evaluation harness
