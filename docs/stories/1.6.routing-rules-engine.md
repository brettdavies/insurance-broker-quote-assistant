...
- **Error Handling**: [routing-engine.ts:47-52](apps/api/src/services/routing-engine.ts#L47-L52) - Graceful handling of missing state/productLine with clear error messages
...
- **Given** a user profile with state and productLine
...
- **Edge Cases**: [routing-engine.test.ts:678-743](apps/api/src/services/__tests__/routing-engine.test.ts#L678-L743) - Comprehensive edge case coverage (missing state, missing productLine, no eligible carriers)
