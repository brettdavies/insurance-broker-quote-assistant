...
- [x] **Task 8: Add Unit Tests** (AC: 1, 2, 6)
  ...
  - [x] Test `getMissingFields()` with product-specific requirements:
    ...
    - [x] Home product: propertyType, constructionYear, squareFeet detected correctly
...
- **Then** missing fields are returned with product-specific requirements (Auto: drivers/vehicles/vins, Home: propertyType/constructionYear/squareFeet, etc.)
