...
if (!serverAvailable) {
  console.warn(
    `⚠️  Server not available at ${API_URL}. Skipping contract tests.`
  )
...
describe('POST /api/intake - Live API Contract Tests', () => {
  ...
  describe('Request Validation', () => {
    it.skipIf(!serverAvailable)('should return 400 for invalid request body', async () => {
    ...
    it.skipIf(!serverAvailable)('should return 400 for missing message field', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
    ...
    it.skipIf(!serverAvailable)('should return 400 for empty message', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  describe('Key-Value Extraction', () => {
    it.skipIf(!serverAvailable)('should extract fields from key-value syntax and validate response schema', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
    ...
    it.skipIf(!serverAvailable)('should handle all field aliases correctly', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  describe('Natural Language Extraction', () => {
    it.skipIf(!serverAvailable)('should extract fields from natural language and validate response schema', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
    ...
    it.skipIf(!serverAvailable)('should handle conversation history', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  describe('Response Schema Validation', () => {
    it.skipIf(!serverAvailable)('should always return valid IntakeResult schema', async () => {
      const testCases = [
    ...
    }, TEST_TIMEOUT * 2) // Longer timeout for multiple requests

    it.skipIf(!serverAvailable)('should include all required IntakeResult fields', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  describe('Error Handling', () => {
    it.skipIf(!serverAvailable)('should return structured error response for invalid requests', async () => {
      const response = await fetch(`${API_URL}/api/intake`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  describe('Performance', () => {
    it.skipIf(!serverAvailable)('should respond within reasonable time for key-value extraction', async () => {
    ...
    it.skipIf(!serverAvailable)('should handle timeout gracefully for LLM calls', async () => {
    ...
    }, TEST_TIMEOUT * 2) // Longer timeout for LLM call
  })
})
