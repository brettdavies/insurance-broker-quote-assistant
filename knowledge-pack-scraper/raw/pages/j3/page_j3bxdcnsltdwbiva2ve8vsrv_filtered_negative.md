...
Continuar
Cancelar
[Skip to main content](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-is-full-coverage-auto-insurance#oneX-main-content)
...
* [ Español ](https://es.statefarm.com/simple-insights/automoviles-y-vehiculos/que-es-seguro-de-auto-de-cobertura-total)
Back
Search
How can we help you?
Search
...
![Young women going for a drive.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/what-is-full-coverage-auto-insurance.jpg)
...
Start a quote
Or learn more about [car insurance](https://www.statefarm.com/insurance/auto) from State Farm
* The difference between your [car loan](https://www.statefarm.com/simple-insights/auto-and-vehicles/car-loan-basics-you-need-to-know) amount and its value [if your vehicle is totaled](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-happens-if-your-car-is-totaled) (gap coverage, which is usually offered by your auto loan provider rather than an insurance company, might help bridge this difference).
* [Liability insurance](https://www.statefarm.com/insurance/auto/coverage-options/liability-coverage)
* **What it covers** — typically includes two components—bodily injury (BI) liability and property damage (PD) liability. Bodily injury coverage usually helps pay for medical expenses, lost wages or funeral costs for others injured in an accident you’re responsible for, while property damage coverage typically helps pay for the repairs to other people’s vehicles or property.
* **What it doesn't cover** — your own [car’s repairs](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-to-know-when-discussing-car-repairs-with-mechanic) or your medical expenses.
* **Requirement** — legally required in most states, but the specific requirements vary. Some states mandate both bodily injury and property damage coverage, while others may require only one. Minimum coverage limits are set by state law.
* [Collision coverage](https://www.statefarm.com/insurance/auto/coverage-options/collision-coverage)
* **What it covers** — damage to your own car resulting from your vehicle overturning or an accident with another vehicle or object. Coverage applies regardless of who is at fault.
* **What it involves** — you pay a deductible (a set amount) before your insurer begins covering costs. For example, if repairs cost $2,000 and your deductible is $500, you are responsible for the first $500 and your insurance covers the rest.
* **Requirement** — typically required by lenders if you finance or lease your car.
* [Comprehensive coverage](https://www.statefarm.com/insurance/auto/coverage-options/comprehensive-coverage)
* **What it covers** — protects your car from non-collision events like [theft](https://www.statefarm.com/simple-insights/auto-and-vehicles/preventing-car-theft), vandalism, natural disasters, [fire](https://www.statefarm.com/simple-insights/auto-and-vehicles/car-fire-what-to-do-if-it-happens-to-you), [floods](https://www.statefarm.com/simple-insights/residence/do-i-need-flood-insurance) or [hitting an animal](https://www.statefarm.com/simple-insights/auto-and-vehicles/immediate-steps-to-take-if-you-hit-a-deer-with-your-car).
* **What it involves** — a deductible may apply.
* **Requirement** — typically required by lenders for financed or leased cars.
* **Your vehicle** — is it old or new? Paid off or leased? If your car is older and its market value is low, it might not make sense to pay for collision and comprehensive coverage. However, these coverages can be beneficial for newer vehicles and may be required if your car is financed or leased.
* **Your budget** — how much fits your budget for premiums? How much could you comfortably pay for a deductible per claim? A higher deductible can lower your monthly premiums but may result in higher out-of-pocket costs if you need to file a claim. Evaluate whether you can afford these costs or if you might choose not to repair your vehicle in the event of a loss.
* **Legal requirements** — you must meet your state’s minimum liability coverage requirements. Consider how much coverage you need as that amount may be more than the minimum limits required by your state. Adding uninsured/underinsured motorist coverage is often recommended.
* **Your driving habits** —
---|---
[Uninsured/underinsured motorist](https://www.statefarm.com/insurance/auto/coverage-options/uninsured-and-underinsured-coverage) | Required in some states. Protects you if you’re hit by a driver who does not have insurance or does not carry sufficient coverage.
[Med Pay/Personal Injury Protection](https://www.statefarm.com/insurance/auto/coverage-options/medical-payments-coverage) | Covers medical expenses for you and passengers, regardless of fault.
[Car rental reimbursement](https://www.statefarm.com/insurance/auto/coverage-options/car-rental-and-travel-expenses-coverage) | Covers rental costs while your car is being repaired after a covered loss.
[Emergency road service](https://www.statefarm.com/insurance/auto/coverage-options/emergency-road-service-coverage) | Provides roadside assistance, including towing or flat tire changes.
[Gap coverage](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-is-gap-insurance-and-what-does-it-cover) | Covers the difference between your car’s value and what you owe on your loan if its totaled.  _This coverage is usually offered through your auto loan provider and not necessarily your insurance company._
...
[![State Farm agent shaking hands with a woman.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/benefits-of-having-an-insurance-agent.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/benefits-of-having-an-insurance-agent)
####  [ The benefits of having an insurance agent ](https://www.statefarm.com/simple-insights/auto-and-vehicles/benefits-of-having-an-insurance-agent)
...
[Español](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-is-full-coverage-auto-insurance)
