Usage-Based Car Insurance | Progressive
Usage-Based Car Insurance | Progressive
[Skip to Main Content](https://www.progressive.com/answers/usage-based-car-insurance/#main)
...
* [Español](https://www.progressive.com/es/answers/usage-based-car-insurance/)
...
Yes! As an industry leader in usage-based insurance, our [Snapshot program](https://www.progressive.com/auto/discounts/snapshot/) customizes your car insurance rate based on your driving habits (how you drive, how much you drive, and when you drive). Drivers who save with Snapshot save an average of $322 a year.*Read the associated disclosure for this claim. We'll even kick in an automatic discount just for trying Snapshot.‡Read the associated disclosure for this claim. While the majority of drivers will save money with Snapshot, your rate could increase as a result of high-risk driving.
### Related articles
...
*Snapshot not available in CA, HI or from all agents. Savings achieved through Snapshot are based on safe driving behavior.
‡For new Progressive customers only. Discount will expire upon renewal of policy. Participation discount not available in HI & NY. Snapshot not available in CA.
Site Navigation
Menu
