...
Continuar
Cancelar
[Skip to main content](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-accident-what-to-do#oneX-main-content)
...
* [ Español ](https://es.statefarm.com/simple-insights/automoviles-y-vehiculos/accidente-de-vehiculo-compartido-que-hacer)
Back
Search
How can we help you?
Search
...
* Rideshare Accident: What Should Drivers Do After A Crash
![Drivers exchange information while standing next to a damaged car hood.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/rideshare-accident-what-to-do.jpg)
Written by [State Farm® Editorial Team ](https://www.statefarm.com/simple-insights/editorial-team-and-process)
**_Overview:_**_While all car accidents are stressful, getting into a car accident as a rideshare driver may be especially challenging. When filing an insurance claim, it is important to check for injuries, call 911, and gather important information from those involved. However, as a rideshare driver, it is also important to understand the rideshare periods. Your insurance coverage could depend on if you were in Period one (app is on and waiting for a request), Period two (en route to passenger) or Period three (passenger occupying vehicle). Knowing what insurance coverage applies when the accident happened can help prepare you for the rideshare claim process._
[Driving for rideshare companies](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-insurance-what-to-know) may be a great way to earn money. However, it also comes with unique challenges, especially after an [auto accident](https://www.statefarm.com/claims/auto/how-to-handle-an-accident). Navigating the insurance process and understanding what coverages might apply at each stage of the ride is important. It’s helpful to understand the steps to follow after a rideshare accident, the information you should gather and how to prepare for the rideshare insurance claim process.
Auto
ZIP CodeEnter 5 digits
Start a quote
Or learn more about [car insurance](https://www.statefarm.com/insurance/auto) from State Farm
A car accident is nerve-racking for anyone, but when you're driving for a rideshare service, you have added responsibilities. Like any accident, your [first steps after a car accident](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-to-do-after-a-car-accident) should focus on safety:
* **Status on rideshare app** —
* **Contact information** —
* **Insurance details** — [insurance company name and policy numbers](https://www.statefarm.com/simple-insights/auto-and-vehicles/electronic-proof-of-insurance) for other drivers involved.
* **Driver's licenses** — [license numbers](https://www.statefarm.com/simple-insights/family/what-is-a-real-id) for all involved drivers.
...
2. **Your personal auto insurance company** —
Your [personal auto policy](https://www.statefarm.com/insurance/auto)
[Rideshare coverage endorsement](https://www.statefarm.com/insurance/auto/coverage-options/rideshare-coverage) (if included in your personal policy)
If you drive for a rideshare service and want to understand your coverage, explore insurance options, be prepared for the unexpected as much as possible, or need help navigating an active claim, [contact a State Farm agent today](https://www.statefarm.com/agent/) or [explore quotes online](https://www.statefarm.com/insurance/auto).
...
[![Woman filling out a parking lot accident report.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/143-parking-lot-accidents-wide.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/how-to-deal-with-parking-lot-accidents)
####  [ How to deal with parking lot accidents ](https://www.statefarm.com/simple-insights/auto-and-vehicles/how-to-deal-with-parking-lot-accidents)
[![Mobile phone displaying the State Farm mobile app with the option for a digital id card.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/05_NeverLoseYourAutoInsuranceIDAgain_750.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/electronic-proof-of-insurance)
####  [ Obtain an electronic proof of insurance card ](https://www.statefarm.com/simple-insights/auto-and-vehicles/electronic-proof-of-insurance)
...
[Español](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-accident-what-to-do)
