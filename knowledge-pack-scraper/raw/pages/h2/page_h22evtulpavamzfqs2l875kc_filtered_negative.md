...
Continuar
Cancelar
[Skip to main content](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-insurance-what-to-know#oneX-main-content)
...
* [ Español ](https://es.statefarm.com/simple-insights/automoviles-y-vehiculos/seguro-de-vehiculo-compartido-lo-que-hay-que-saber)
Back
Search
How can we help you?
Search
...
![A smiling rideshare driver checks his rearview window on his passenger.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/rideshare-insurance-what-to-know.jpg)
Written by [State Farm® Editorial Team ](https://www.statefarm.com/simple-insights/editorial-team-and-process)
**_Overview:_**_If you're driving for a rideshare service, your personal car insurance policy might not cover you while you're working. Because standard policies often exclude carrying persons for a charge, specialized rideshare insurance may be necessary in order to help protect yourself from potentially significant financial risks. Understanding the difference and finding the right coverage for you can help keep you protected while earning income on the road._
[Rideshare driving](https://www.statefarm.com/simple-insights/auto-and-vehicles/are-uber-and-lyft-safe) has become a popular way to earn extra income or build a full-time career. Transportation Network Companies (also known as TNCs) offer flexibility and convenience, which allows drivers to set their own schedules. However, many drivers are not fully aware of the unique insurance requirements that come with this role. Driving for TNCs could expose you to risks that aren't covered by personal auto insurance. [Rideshare insurance](https://www.statefarm.com/insurance/auto/coverage-options/rideshare-coverage) can help bridge the coverage gap and offer coverage during the different periods of ridesharing.
Auto
ZIP CodeEnter 5 digits
Start a quote
Or learn more about [car insurance](https://www.statefarm.com/insurance/auto) from State Farm
Your personal auto insurance is designed for private use, such as commuting, errands or leisure travel. While this generally includes standard coverages (such as [liability insurance](https://www.statefarm.com/insurance/auto/coverage-options/liability-coverage), [collision insurance](https://www.statefarm.com/insurance/auto/coverage-options/collision-coverage) and [comprehensive insurance](https://www.statefarm.com/insurance/auto/coverage-options/comprehensive-coverage)), it typically excludes commercial activities like "driving for hire."
* **Financial hardship** — with denied claims or policy cancellations, you could be required to pay for damage, lawsuits or [medical bills](https://www.statefarm.com/insurance/auto/coverage-options/medical-payments-coverage) out of pocket.
* **Talk to your insurance agent** — share your rideshare activities when [discussing coverage with your agent](https://www.statefarm.com/simple-insights/financial/insurance-questions-to-ask-your-agent).
* **Read your new policy** — [read through your new policy](https://www.statefarm.com/simple-insights/auto-and-vehicles/how-to-read-auto-insurance-quotes) to fully understand the terms, coverage limits and potential exclusions. Insurers may have different requirements depending on your state or the rideshare service you’re driving for.
Having rideshare insurance can help you focus on driving protected while earning income. To learn more about rideshare insurance options to help fit your needs, [contact a State Farm agent today](https://www.statefarm.com/agent/) or [explore quotes online](https://www.statefarm.com/insurance/auto).
...
###  Related articles
[![ A female rideshare passenger checks her app after securing her seatbelt.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/common-rideshare-insurance-misconceptions.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/common-rideshare-insurance-misconceptions)
####  [ 5 common rideshare insurance misconceptions debunked ](https://www.statefarm.com/simple-insights/auto-and-vehicles/common-rideshare-insurance-misconceptions)
[![A smiling driver checks his passenger confident that State Farm has them covered.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/safety-tips-for-uber-and-lyft-wide.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/are-uber-and-lyft-safe)
####  [ Benefits and safety tips for Uber and Lyft ](https://www.statefarm.com/simple-insights/auto-and-vehicles/are-uber-and-lyft-safe)
[![Drivers exchange information while standing next to a damaged car hood.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/rideshare-accident-what-to-do.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-accident-what-to-do)
####  [ Rideshare accident: What should drivers do after an accident ](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-accident-what-to-do)
...
[Español](https://www.statefarm.com/simple-insights/auto-and-vehicles/rideshare-insurance-what-to-know)
