...
Continuar
Cancelar
[Skip to main content](https://www.statefarm.com/simple-insights/residence/do-you-need-earthquake-insurance#oneX-main-content)
...
* [ Español ](https://es.statefarm.com/simple-insights/residencia/necesitas-seguro-para-terremotos)
Back
Search
How can we help you?
Search
...
![Houses with earthquake damage where one is leaning to the left and sunk in.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/do-you-need-earthquake-insurance.jpg)
Written by [State Farm® Editorial Team ](https://www.statefarm.com/simple-insights/editorial-team-and-process)
Many people might think that earthquakes are only likely to occur in California. But according to the [U.S. Geological Survey (USGS)](https://www.usgs.gov/index.php/news/national-news-release/new-usgs-map-shows-where-damaging-earthquakes-are-most-likely-occur-us), about 75% of the U.S. could be exposed to earthquakes. With most of the United States potentially exposed for earthquakes, it's important to understand how your homeowners insurance and earthquake insurance work together.
Many standard insurance policies for [homeowners](https://www.statefarm.com/insurance/homeowners), [condo unitowners](https://www.statefarm.com/insurance/condo-unit-owners) and [renters](https://www.statefarm.com/insurance/renters) **do not** cover damages caused by earthquakes. One exception may be if an earthquake causes a fire, in which case the policy will typically cover the fire damage, but not the earthquake-related damages to structures or property.
Most insurance companies offer earthquake insurance as an endorsement to a homeowners, condo unitowners or renters policy or as a separate, stand-alone earthquake policy. Depending on statistical and risk-assessment factors, the additional premium will vary by state with rates typically being lower in states with less seismic activity. If you live in California, you can use the [California Earthquake Authority’s premium calculator](https://www.earthquakeauthority.com/california-earthquake-insurance-policies/earthquake-insurance-premium-calculator) to help determine rates in your area.
* **What's the cost to replace my possessions?**[Replacement costs ](https://www.statefarm.com/simple-insights/residence/replacement-cost-vs-market-value)for major appliances and other expensive items in your home could add up to a substantial sum.
...
* **How much would it cost to replace my home?** Your earthquake coverage should match the level of [coverage on your homeowners insurance](https://www.statefarm.com/simple-insights/residence/replacement-cost-vs-market-value) to help protect you in the event the earthquake causes severe damage to your home.
* **What about personal property?** Confirm with your insurance company what type of personal property may be covered for earthquake damage and if there are any special coverage limits. Consider getting a [personal articles policy](https://www.statefarm.com/insurance/personal-articles-policy) for items exceeding the special coverage limit or if they are excluded from earthquake coverage.
...
* **Cars** — damage to your cars as a result of an earthquake is typically not covered, but can be covered by [comprehensive coverage](https://www.statefarm.com/insurance/auto/coverage-options/comprehensive-coverage) on your auto policy.
Most of the world's biggest earthquakes take place along the U.S. Pacific Coast, stretching from Southern California to Alaska. To help encourage Californians to purchase earthquake coverage, the [California Earthquake Authority™ (CEA)](https://www.earthquakeauthority.com/) was created in 1995. The CEA is a nonprofit, privately funded insurer created by the state's government to help make earthquake insurance more affordable. This policy option is available through most California insurance carriers.
Additionally, if you live within 20 miles of a volcano, take a moment to find out more about how your family can help [prepare for and respond to a volcano eruption](https://www.statefarm.com/simple-insights/residence/volcano-safety-tips-and-precautions).
To learn more about earthquake insurance and whether it's available in your area, [contact your insurance agent](https://www.statefarm.com/agent/).
...
###  Related articles
[![Couple painting their living room.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/replacement-cost-vs-market-value.jpg) ](https://www.statefarm.com/simple-insights/residence/replacement-cost-vs-market-value)
####  [ What you need to know about replacement cost vs market value ](https://www.statefarm.com/simple-insights/residence/replacement-cost-vs-market-value)
[![Street view of a home.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/prepare-for-an-earthquake.jpg) ](https://www.statefarm.com/simple-insights/residence/prepare-for-an-earthquake)
####  [ Preparing your home for an earthquake ](https://www.statefarm.com/simple-insights/residence/prepare-for-an-earthquake)
[![A house damaged by an earthquake sits atop a hill that is covered in debris.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/what-to-do-during-an-earthquake.jpg) ](https://www.statefarm.com/simple-insights/residence/what-to-do-during-an-earthquake)
...
[Español](https://www.statefarm.com/simple-insights/residence/do-you-need-earthquake-insurance)
