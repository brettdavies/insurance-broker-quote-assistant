...
Continuar
Cancelar
[Skip to main content](https://www.statefarm.com/simple-insights/auto-and-vehicles/liability-insurance-gaps#oneX-main-content)
...
* [ Español ](https://es.statefarm.com/simple-insights/automoviles-y-vehiculos/brechas-en-el-seguro-de-responsabilidad-civil)
Back
Search
How can we help you?
Search
...
* Liability Insurance Gaps: What’s Not Covered?
![Young people involved in a car crash.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/liability-insurance-gaps.jpg)
Written by [State Farm® Editorial Team ](https://www.statefarm.com/simple-insights/editorial-team-and-process)
**_Overview:_**_Liability insurance covers damage or injuries you cause to others in a crash, in the case of a covered claim or loss, but it does not pay for repairs to your own vehicle or your medical bills if you’re at fault. This article outlines the limitations of liability coverage and explains why adding options like collision, comprehensive and Medical Payments Coverage (Med Pay) or Personal Injury Protection (PIP) may be important for broader protection. Understanding what is and isn’t covered can help you choose the right auto insurance coverages to fit your needs._
...
[Liability insurance](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-is-liability-insurance-coverage) is meant to help protect other people—not you. The main coverage gaps you may face with liability-only insurance are:
Pays to [repair or replace your car after a collision](https://www.statefarm.com/simple-insights/auto-and-vehicles/should-you-repair-or-replace-your-car), no matter who is at fault.
Damage to your own car (from events like [theft](https://www.statefarm.com/simple-insights/auto-and-vehicles/preventing-car-theft), [fire](https://www.statefarm.com/simple-insights/auto-and-vehicles/car-fire-what-to-do-if-it-happens-to-you), [hail](https://www.statefarm.com/simple-insights/auto-and-vehicles/hail-damage-car), [flood](https://www.statefarm.com/simple-insights/auto-and-vehicles/what-to-do-if-your-car-has-flood-damage) or [hitting an animal](https://www.statefarm.com/simple-insights/auto-and-vehicles/immediate-steps-to-take-if-you-hit-a-deer-with-your-car))
* **Solution** —[collision coverage](https://www.statefarm.com/insurance/auto/coverage-options/collision-coverage) pays for repairs to your car, or it’s actual cash value (the [depreciated value](https://www.statefarm.com/simple-insights/auto-and-vehicles/calculate-your-vehicle-depreciation) at the time of the accident) if it’s totaled, no matter who is at fault. However, if another driver is at fault, their liability insurance typically covers your damages. You would use your own collision coverage if you are at fault, if the other driver is uninsured, underinsured, can’t be identified (as in a hit-and-run) or if their coverage is insufficient. Your chosen deductible will apply.
* **Solution** —[comprehensive coverage](https://www.statefarm.com/insurance/auto/coverage-options/comprehensive-coverage) pays for covered losses not caused by a collision. A deductible may apply.
...
* **Solution** — this is where [Med Pay](https://www.statefarm.com/insurance/auto/coverage-options/medical-payments-coverage) coverage or PIP comes in.
* [**Uninsured/underinsured motorist**](https://www.statefarm.com/insurance/auto/coverage-options/uninsured-and-underinsured-coverage) — helps if the other driver has no liability coverage or not enough coverage.
Adding these [coverages](https://www.statefarm.com/insurance/auto/coverage-options)[](https://www.statefarm.com/insurance/auto/coverage-options) may help you avoid large bills and potentially give you greater confidence while driving. To discuss your current coverage or get advice on building a more comprehensive policy, [contact your insurance agent](https://www.statefarm.com/agent).
By knowing where liability insurance falls short, [you can make informed choices about your protection](https://www.statefarm.com/simple-insights/auto-and-vehicles/car-insurance-deductibles-and-coverages-choosing-well) and help avoid costly coverage gaps.
...
###  Related articles
[![Six children are jumping with excitement outside in front of an SUV with the back hatch open.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/what-is-individual-liability-insurance%201.jpg) ](https://www.statefarm.com/simple-insights/residence/what-is-individual-liability-insurance-and-what-does-it-cover)
...
[![A man and woman calling their agents to see if they have collision insurance after a car accident.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/do-i-need-collision-insurance.jpg) ](https://www.statefarm.com/simple-insights/auto-and-vehicles/do-i-need-collision-insurance)
####  [ Protecting your car: Do I need collision insurance? ](https://www.statefarm.com/simple-insights/auto-and-vehicles/do-i-need-collision-insurance)
...
[Español](https://www.statefarm.com/simple-insights/auto-and-vehicles/liability-insurance-gaps)
