...
Continuar
Cancelar
[Skip to main content](https://www.statefarm.com/simple-insights/residence/home-inventory-how-to-create-one#oneX-main-content)
...
* [ Español ](https://es.statefarm.com/simple-insights/residencia/inventario-del-hogar-como-crear-uno)
Back
Search
How can we help you?
Search
...
![Pieces of fine china on a table.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/creating-a-home-inventory.jpg)
Written by [State Farm® Editorial Team ](https://www.statefarm.com/simple-insights/editorial-team-and-process)
Imagine needing to list every possession in your home or apartment, along with each item's worth after your belongings have been stolen or destroyed in a [hurricane](https://www.statefarm.com/simple-insights/residence/what-to-do-after-a-hurricane), [tornado](https://www.statefarm.com/simple-insights/residence/what-to-do-in-a-tornado), [wildfire](https://www.statefarm.com/simple-insights/residence/wildfire-safety-tips) or other natural disaster. That task may seem impossible, so it may be helpful to make the list before you need it.
A home inventory can be an excellent way to help make [home insurance](https://www.statefarm.com/insurance/homeowners) and [renters insurance](https://www.statefarm.com/insurance/renters) [coverage decisions](https://www.statefarm.com/simple-insights/residence/what-are-all-the-different-types-of-insurance "What are the different types of insurance") and expedite the [claims process](https://www.statefarm.com/claims). Recording your [insurable assets](https://www.statefarm.com/simple-insights/financial/types-of-personal-assets) can help you settle a covered loss or claim, verify tax-deductible property losses and determine the insurance coverage amount you need. A home inventory list can also assist you with estate planning or dividing possessions during life changes, such as a [divorce](https://www.statefarm.com/simple-insights/financial/how-to-prepare-for-a-divorce).
Homeowners
ZIP CodeEnter 5 digits
Start a quote
* **Written inventory** — a comprehensive home inventory list catalogs your belongings. Try to include the item description (make, model and serial number, if applicable), value, where you bought it and the purchase date. You can create your list using a spreadsheet or fill out a [home inventory checklist](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/pdf/V-home_inventory_checklist.pdf) to help you get started.
Once you decide on the type of home inventory you want to create, according to the [Insurance Information Institute](https://www.iii.org/article/how-create-home-inventory), there are some simple steps you can take to start the process. Also, consider obtaining [appraisals for your most valuable possessions](https://www.statefarm.com/simple-insights/residence/how-to-appraise-and-insure-collectibles), such as antiques, art, jewelry, collectibles and electronic equipment. If you have any questions about which items may be covered by your policy, [contact your insurance agent](https://www.statefarm.com/agent/).
* **Record possessions if you pack for a move** — when [moving to a new apartment or home](https://www.statefarm.com/simple-insights/residence/packing-tips-for-moving), take some extra time to record the belongings in each room.
* **Include stored items as well** — these could include items kept in your basement, attic, garage, [detached structures](https://www.statefarm.com/simple-insights/residence/backyard-structures-and-home-insurance) or a self-storage unit.
[ Video Transcript ](javascript:void\(0\))
Don't let your home inventory become part of a property loss. Whichever inventory method you choose, it's important to [keep a copy of your property checklist in a fireproof safe](https://www.statefarm.com/simple-insights/residence/home-safes-for-protection), safety deposit box or digitally in the cloud. You can even email your inventory to your insurance agent. Sending the list may have the added value of allowing your inventory to be reviewed by your agent to see if you need extra home or [renters coverage](https://www.statefarm.com/simple-insights/residence/how-much-renters-insurance-do-i-need) or to add a [personal articles insurance policy](https://www.statefarm.com/insurance/personal-articles-policy). To help maintain an accurate inventory list, update it annually or anytime you move. This might help save you time and stress in the future if you experience a loss.
* [Claims Hub](https://www.statefarm.com/claims "State Farm claims center")
* [Homeowners forms](https://www.statefarm.com/claims/home-and-property/homeowner-forms "Personal property inventory tools") on our website
* By contacting your [claim handler](https://www.statefarm.com/customer-care/contact-us "State Farm - contact us")
**Note:**_All applicable policy provisions and jurisdictions may apply._
##  Start a quote
...
[![Woman fluffing pillows on couch while preparing a home for sale](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/preparing-to-sell-your-home.jpg) ](https://www.statefarm.com/simple-insights/residence/preparing-to-sell-your-home)
####  [ Preparing to sell your home ](https://www.statefarm.com/simple-insights/residence/preparing-to-sell-your-home)
[![Woman putting documents into a box.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/save-or-shred-how-long-to-keep-documents-wide.jpg) ](https://www.statefarm.com/simple-insights/financial/save-or-shred-how-long-to-keep-documents)
...
[![A couple celebrating their new home.](https://www.statefarm.com/content/dam/sf-library/en-us/secure/legacy/simple-insights/home-basics-wide.jpg) ](https://www.statefarm.com/simple-insights/residence/checklist-for-moving-into-a-new-house)
####  [ Checklist for moving into a new house ](https://www.statefarm.com/simple-insights/residence/checklist-for-moving-into-a-new-house)
#####  Simple Insights
The Basics
* [Auto & vehicle ](https://www.statefarm.com/simple-insights/auto-and-vehicles)
* [Banking](https://www.statefarm.com/simple-insights/banking)
...
[Español](https://www.statefarm.com/simple-insights/residence/home-inventory-how-to-create-one)
