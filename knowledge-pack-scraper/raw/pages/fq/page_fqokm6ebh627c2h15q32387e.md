[Skip to Main Content](https://www.valuepenguin.com/progressive-snapshot-insurance-review#main-content)
...
[Skip to content](https://www.valuepenguin.com/progressive-snapshot-insurance-review#main-content)
# Progressive Snapshot Review: How Does it Work?
![](https://res.cloudinary.com/value-penguin/image/upload/w_30/employee_photos/Cate_Deventer_VP_V2)
Written by [ Cate Deventer ](https://www.valuepenguin.com/author/cate-deventer)
Updated Aug 27, 2025
...
Find Insurers
[![](https://res.cloudinary.com/value-penguin/image/upload/w_200/referral_logos/us/insurance/progressive-2)](https://www.progressive.com/auto/discounts/snapshot/ "Progressive Snapshot")
Progressive Snapshot tracks your driving habits and gives you a personalized discount. **But 1 in 5 drivers will see their rates go up with Snapshot, so the program is risky.** Snapshot isn't the best option, because other companies have a bigger discount and won't increase your rates if you're a bad driver.
  * [Alternatives to Snapshot #alternatives ](https://www.valuepenguin.com/progressive-snapshot-insurance-review#alternatives "#alternatives")
  * [What is Progressive Snapshot? #what ](https://www.valuepenguin.com/progressive-snapshot-insurance-review#what "#what")


  * [How does Snapshot work? #how ](https://www.valuepenguin.com/progressive-snapshot-insurance-review#how "#how")
  * [Is Progressive Snapshot worth it? #worth-it ](https://www.valuepenguin.com/progressive-snapshot-insurance-review#worth-it "#worth-it")


## Alternatives to Progressive Snapshot
[ For good savings: Nationwide SmartRide ![Nationwide](https://res.cloudinary.com/value-penguin/image/upload/c_limit,dpr_1.0,f_auto,q_auto,w_150/referral_logos/us/insurance/nationwide-4) For good savings: Nationwide SmartRide ](https://www.valuepenguin.com/nationwide-smartride-insurance-review "For good savings: Nationwide SmartRide")[ To avoid rate increases: Liberty Mutual RightTrack ![Liberty Mutual](https://res.cloudinary.com/value-penguin/image/upload/c_limit,dpr_1.0,f_auto,q_auto,w_800/referral_logos/us/insurance/libertymutual-3) To avoid rate increases: Liberty Mutual RightTrack ](https://www.valuepenguin.com/right-track-liberty-mutual-insurance-review "To avoid rate increases: Liberty Mutual RightTrack")[ If you drive a lot: State Farm Drive Safe and Save ![State Farm](https://res.cloudinary.com/value-penguin/image/upload/c_limit,dpr_1.0,f_auto,q_auto,w_150/referral_logos/us/insurance/state-farm-3) If you drive a lot: State Farm Drive Safe and Save ](https://www.valuepenguin.com/state-farm-drive-safe-and-save-insurance-review "If you drive a lot: State Farm Drive Safe and Save")
## Pros and cons
**Pros**
Only monitors you for a short period
Offers an app or a plug-in device
**Cons**
Lower discount than some programs
Rates can go up
Phone use counts against you
Charges you for driving far each day
* * *
## What is Progressive Snapshot?
Progressive Snapshot is a free [usage-based insurance program](https://www.valuepenguin.com/car-insurance/telematics "Telematics Insurance: Is It Right for You?") that tracks your driving to give you a discount.
...
The app and plug-in device versions of Snapshot [have a few differences Progressive Snapshot app vs. plug-in device ](https://www.valuepenguin.com/progressive-snapshot-insurance-review#app-vs-device "Progressive Snapshot app vs. plug-in device") but both follow the same five steps.
  1. Join the program.
...
** In most states, Snapshot is also available as a trial for drivers who don't have insurance with Progressive.** The program, called Snapshot Road Test, is 30 days long and allows you to see what kind of discount you would earn from Progressive. Road Test is only available in the mobile app version and not via the plug-in device.
### Privacy and data sharing concerns
**Make sure you're comfortable with the[info the mobile app version of Snapshot collects about you What does Snapshot track? ](https://www.valuepenguin.com/progressive-snapshot-insurance-review#track "What does Snapshot track?") before signing up.**
![](https://res.cloudinary.com/value-penguin/image/upload/w_60//icons/law-penalties2)
A recent lawsuit against Toyota raised questions about whether automakers use built-in tracking technology to share driving data with companies like Progressive without clear customer consent.
While the case is ongoing, it highlights the importance of understanding how programs like Snapshot may collect and use your driving data.
### Progressive Snapshot app vs. plug-in device
![](https://res.cloudinary.com/value-penguin/image/upload/w_70/icons/mobile)
![](https://res.cloudinary.com/value-penguin/image/upload/c_limit,f_auto,w_70,dpr_1.0,q_auto/icons/mobile)
...
![](https://res.cloudinary.com/value-penguin/image/upload/w_70/icons/car)
![](https://res.cloudinary.com/value-penguin/image/upload/c_limit,f_auto,w_70,dpr_1.0,q_auto/icons/car)
...
Other things that Progressive Snapshot tracks
...
You aren't sure if you're a good driver
  * **Why?** Unlike with some other programs, your rates with Progressive could go up if you get a bad Snapshot score. 
  * **Better options:** Most other usage-based programs won't increase your rates. Try [State Farm Drive Safe & Save](https://www.valuepenguin.com/state-farm-drive-safe-and-save-insurance-review "State Farm Drive Safe & Save Review"), [Liberty Mutual RightTrack](https://www.valuepenguin.com/right-track-liberty-mutual-insurance-review "Liberty Mutual RightTrack Review") or [Nationwide SmartRide](https://www.valuepenguin.com/nationwide-smartride-insurance-review "Is Nationwide SmartRide Worth It?"). 
...
You drive often
  ...
  * **Most usage-based programs look at how often you drive.** If you drive a lot or drive late in the night, these types of discounts probably aren't right for you. Look into other ways to [save on car insurance](https://www.valuepenguin.com/tips-save-car-insurance "Tips to Save Money on Car Insurance"), like shopping around or using different discounts. 
...
If Progressive Snapshot isn't a good fit for you, you may be able to [find a better usage-based program](https://www.valuepenguin.com/best-usage-based-car-insurance "Best Usage-Based Car Insurance Companies") to help you save money on car insurance. For example, Nationwide's SmartRide program can earn you a discount of up to 40%, it doesn't track your phone usage, and your rate won't go up if you have bad driving habits.
Find Cheap Auto Insurance Quotes in Your Area
Insurance Type
Auto Home Life Motorcycle Renters Health Medicare
ZIP Code
...
* * *
## Methodology
Info about the Progressive Snapshot program is from Progressive's website. Program info for other insurance companies was gathered from their websites.
About the Author
