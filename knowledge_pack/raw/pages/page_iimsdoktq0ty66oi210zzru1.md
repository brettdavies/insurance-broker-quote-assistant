Multi-Car Insurance: How Does It Work? | Progressive
Multi-Car Insurance: How Does It Work? | Progressive
[Skip to Main Content](https://www.progressive.com/answers/multi-car-insurance/#main)
...
Explore Progressive Answers' [auto editorial guidelines](https://www.progressive.com/answers/auto-editorial-standards/) to find out why you can trust the car insurance information you find here.
  ...
  4. How does multi-car insurance work?
...
Some coverages are customizable to each vehicle. Generally speaking, your liability and [uninsured motorist coverage](https://www.progressive.com/answers/uninsured-motorist-insurance/) limits are set at the policy level, which means you can't customize them to each driver or vehicle on the policy. However, with [collision](https://www.progressive.com/answers/collision-insurance/) and [comprehensive coverage](https://www.progressive.com/answers/comprehensive-insurance/) you can typically choose different deductibles for each vehicle.
### Can I get a discount for having multiple cars on my insurance with Progressive's multi-car discount?
Yes, you can earn a [multi-car discount](https://www.progressive.com/auto/discounts/) when you have more than one vehicle listed on your Progressive auto insurance policy. Just add any car belonging to a spouse, family member, or [roommate](https://www.progressive.com/answers/car-insurance-with-roommates/) to your policy, and you will receive the multi-car discount as long as the car is kept primarily at your address. Learn other ways to get [affordable car insurance](https://www.progressive.com/auto/discounts/cheap-car-insurance/).
### Are there limits to how many drivers can be added onto multi-car insurance policies?
Insurance companies have different rules about who can or can't be added to a car insurance policy, as well as how many drivers can be listed. Spouses and children who live at the same address where the cars are kept should generally be added (assuming they're eligible to drive), though in some cases there may be drivers who are excluded. In many cases, roommates and significant others you live with should also be added as drivers. Learn more about [car insurance for unmarried couples](https://www.progressive.com/answers/car-insurance-for-unmarried-couples/).
